...
<nav x-data="{ open: false }" class="bg-bg dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 fixed top-0 left-0 w-full h-16 z-50 shadow {{ $class }}">
                ...
                @auth
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div 
                            ...
                            class="absolute right-0 mt-2 w-40 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg shadow py-2 z-50"
                            x-cloak
                        >
